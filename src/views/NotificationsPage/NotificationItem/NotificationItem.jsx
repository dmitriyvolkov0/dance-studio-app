...
export default function NotificationItem({data, onClickReadNotification}) {
    ...
    return (
        <div className='relative px-[20px] pt-[30px] pb-[20px] shadow-lg bg-white rounded-[10px]'>
            ...
            {data.type === 'admin_message' &&
                <Button onClick={() => onClickReadNotification(data)} className="w-full mt-3" butSize="sm">Читать</Button>
            }
